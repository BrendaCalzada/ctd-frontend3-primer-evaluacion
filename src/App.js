...
class App extends React.Component {
  ...
  handlerClick = (e) => {
    ...
    let proxHistoria= this.state.dataJson.find((item)=> item.id === (id + idBoton))
    ...
    return (
      <div className="App">
        {this.state.loading ? (
          ...
          <div>
            <Historia inicial={this.state.inicial} historial={this.state.historial} handlerClick={this.handlerClick}/>
          </div>
        )}
      </div>
    );
